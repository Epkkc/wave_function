    ...
    public void setNumberOfNodes(List<TransformerConfiguration> configurations) {
        ...
        if ((baseConfiguration.getRequiredNumberOfNodes() - 1) > baseConfiguration.getRequiredNumberOfEdges()) {
            throw new UnsupportedOperationException(
                String.format("Количество ветвей=%d не может быть меньше, чем количество узлов=%d минус 1", baseConfiguration.getRequiredNumberOfEdges(),
                    baseConfiguration.getRequiredNumberOfNodes()));
        }
