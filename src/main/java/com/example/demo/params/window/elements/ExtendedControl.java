...
package com.example.demo.params.window.elements;
...
public class ExtendedControl extends TextField {
    ...
    @Override public String getUserAgentStylesheet() {
        if (null == userAgentStyleSheet) { userAgentStyleSheet = getClass().getResource("/css/text.input/text_input.css").toExternalForm(); }
